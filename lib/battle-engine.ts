    ...
    try {
      switch (damageType) {
        case "energy":
          ...
          zzfx(...[, , 925, 0.01, 0.01, 0.09, 1, 1.65, , , , , , , , 0.1, , 0.9, 0.01])
          break
        case "thermal":
          // Flame thrower whoosh
          zzfx(...[, , 315, 0.01, 0.02, 0.04, 4, 0.76, , , , , , 1.2, , 0.1, , 0.95, 0.02])
          break
        case "viral":
          // Bio-weapon organic pulse
          zzfx(...[, , 182, 0.01, 0.01, 0.05, 4, 1.88, -7, , , , , 1.1, , 0.1, , 0.88, 0.01])
          break
        case "corrosive":
          // Acid hiss
          zzfx(...[, , 218, 0.01, 0.01, 0.08, 4, 1.22, , , , , , 1.4, , 0.1, , 0.85, 0.01])
          break
        case "explosive":
          // Heavy thump
          zzfx(...[, , 568, 0.04, 0.01, 0.12, 4, 0.54, , , , , , , , 0.2, , 1.0, 0.02])
          break
        case "glacial":
          // Crystalline ice shot
          zzfx(...[, , 769, 0.01, 0.01, 0.06, 1, 2.18, , , , , , , , 0.1, , 0.86, 0.01])
          break
        case "kinetic":
        default:
          // Standard ballistic shot - sharp mechanical click
          zzfx(...[, , 1e3, 0.01, , 0.03, 1, 1.94, , , , , , , , 0.1, , 0.9, 0.01])
          break
      }
    } catch (error) {
