    ...
    <div className="relative w-full h-dvh flex items-center justify-center bg-[#0a0015] overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-3 sm:px-8 py-4 sm:py-0">
        ...
        <div className="flex items-center justify-center gap-2 sm:gap-8 mb-4 sm:mb-8">
          ...
          {/* Character Card - Reduced max height on mobile for better spacing */}
          <div
          ...
          >
            ...
            <div className="relative h-full flex flex-col p-3 sm:p-8">
              {/* Name - Reduced spacing on mobile */}
              <div className="text-center mb-3 sm:mb-6">
                ...
                <p className="text-gray-400 text-xs sm:text-lg">{selectedCharacter.description}</p>
              </div>

              {/* Playstyle - More compact on mobile */}
              <div className="mb-3 sm:mb-6 p-2 sm:p-4 rounded bg-black/40 border border-gray-700">
                <p className="text-[10px] sm:text-sm text-gray-500 mb-0.5 sm:mb-1">PLAYSTYLE</p>
                <p className="text-cyan-300 text-xs sm:text-base">{selectedCharacter.playstyle}</p>
              </div>

              {/* Starting Protocols - Adjusted height for mobile */}
              ...
              {/* Stats - Hidden on mobile as they're redundant */}
              <div className="hidden sm:grid mt-4 grid-cols-2 gap-4 text-sm">
                <div className="p-2 rounded bg-black/40 border border-gray-700">
                  <p className="text-gray-500 text-xs">TRIGGERS</p>
                  <p className="text-white font-bold text-xl">{selectedCharacter.startingTriggers.length}</p>
                </div>
                <div className="p-2 rounded bg-black/40 border border-gray-700">
                  <p className="text-gray-500 text-xs">ACTIONS</p>
                  <p className="text-white font-bold text-xl">{selectedCharacter.startingActions.length}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-2 sm:gap-6 px-4 sm:px-0 mb-3 sm:mb-6">
          ...
          <Button
            ...
            size="lg"
            className="px-6 sm:px-12 py-4 sm:py-6 text-base sm:text-xl font-bold border-2 transition-all active:scale-95"
            style={{
              borderColor: selectedCharacter.color,
              backgroundColor: `${selectedCharacter.color}20`,
              color: selectedCharacter.color,
        ...
        {/* Character Indicators - Added bottom padding to prevent cutoff */}
