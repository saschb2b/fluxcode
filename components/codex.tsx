...
import { EnemyCodex } from "./enemy-codex";
...
export function Codex({ isOpen, onClose }: CodexProps) {
  const [activeTab, setActiveTab] = useState<
    "triggers" | "actions" | "damage-types" | "enemies"
  >("triggers");
                        ...
                        <div className="space-y-3 sm:space-y-4 font-mono">
                            ...
                            <div className="flex items-center gap-2 mb-2 flex-wrap">
                              ...
                              {"coreType" in selectedItem && (
                                ...
                                >
                                  ...
                                  />
                                  {
                                    getCoreTypeInfo(selectedItem as Action)
                                      .label
                                  }
                                </div>
                              )}
                          ...
                          {"coreType" in selectedItem && (
                            ...
                            >
                              ...
                              <div className="text-xs sm:text-sm text-foreground leading-relaxed">
                                {(selectedItem as Action).coreType ===
                                "movement"
